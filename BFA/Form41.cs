...
namespace BFA
{
    public partial class Form41 : Form
    {
        ...
        private void showdata()
        {
            ...
            cmd.CommandText = "SELECT ชื่อโค2,เลขโค2,ชื่อเจ้าของ,ชื่อฟาร์ม,สถานะ,day,รับ FROM ลูกผสม2";
        ...
        private void Form41_Load(object sender, EventArgs e)
        {
            ...
            string sql = $"SELECT * FROM ลูกผสม2";
            ...
            string sql0 = $"SELECT * FROM ลูกผสม2 WHERE สถานะ = 'ได้รับแล้ว'";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            label4.Text = dataGridView1.Rows[e.RowIndex].Cells["ชื่อโค2"].FormattedValue.ToString();
            label6.Text = dataGridView1.Rows[e.RowIndex].Cells["เลขโค2"].FormattedValue.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MySqlConnection conn = new MySqlConnection("host=localhost;user=root;password=;database=สมาคมฟาร์มโค");
                    String sql = "UPDATE ลูกผสม2 SET สถานะ = '" + comboBox1.Text + "',รับ = '" + textBox1.Text + "' WHERE เลขโค2 = '" + label6.Text + "'";
