                        ...
                        if (dt4.Rows.Count <= 0)
                        {
                            ...
                            if (dt5.Rows.Count > 0)
                            {
                                ...
                                if (dt6.Rows.Count < 1)
                                {
                                    ...
                                    if (dt7.Rows.Count < 1)
                                    {
                                        String SQL = "INSERT INTO เลือดร้อยตัวผู้ (ชื่อโค100ตัวผู้,เลขโค100ตัวผู้,ชื่อพ่อโค100ตัวผู้,ชื่อแม่โค100ตัวผู้,เลขพ่อโค100ตัวผู้,เลขแม่โค100ตัวผู้,ชื่อเจ้าของ,ชื่อฟาร์ม,สถานะ,day,รับ) VALUES('" + textBox1.Text + "' , '" + textBox2.Text + "' '" + textBox10.Text + "' , '" + comboBox2.Text + "' , '" + comboBox4.Text + "' , '" + comboBox1.Text + "' , '" + comboBox3.Text + "' , '" + textBox7.Text + "' , '" + textBox8.Text + "' , 'ยังไม่ได้รับ'  , '" + label14.Text + "' , '00/00/0000')";
