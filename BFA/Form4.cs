            ...
            else
            {
                if (textBox10.Text.Length <= 5)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (dt6.Rows.Count < 1)
                        {
                            String SQL = "INSERT INTO ลูกผสม (ชื่อโค,เลขโค,ชื่อพ่อโค,ชื่อแม่โค,เลขพ่อโค,เลขแม่โค,ชื่อเจ้าของ,ชื่อฟาร์ม,สถานะ,day,รับ) VALUES('" + textBox1.Text + "' , '" + textBox2.Text + "' '" + textBox10.Text + "' '" + textBox11.Text + "' , '" + comboBox2.Text + "' , '" + textBox6.Text + "' , '" + comboBox1.Text + "' , '" + textBox5.Text + "' , '" + textBox7.Text + "' , '" + textBox8.Text + "' , 'ยังไม่ได้รับ' , '" + label14.Text + "' , '00/00/0000')";
