                ...
                if (textBox10.Text.Length <= 5)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (dt4.Rows.Count > 0)
                        {
                            ...
                            if (dt6.Rows.Count < 1)
                            {
                                String SQL = "INSERT INTO ลูกผสม2 (ชื่อโค2,เลขโค2,ชื่อพ่อโค2,ชื่อแม่โค2,เลขพ่อโค2,เลขแม่โค2,ชื่อเจ้าของ,ชื่อฟาร์ม,สถานะ,day,รับ) VALUES('" + textBox1.Text + "' , '" + textBox2.Text + "' '" + textBox10.Text + "' '" + textBox11.Text + "' , '" + comboBox2.Text + "' , '" + comboBox4.Text + "' , '" + comboBox1.Text + "' , '" + comboBox3.Text + "' , '" + textBox7.Text + "' , '" + textBox8.Text + "' , 'ยังไม่ได้รับ' , '" + label14.Text + "' , '00/00/0000')";
