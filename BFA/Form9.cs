                ...
                if (textBox10.Text.Length <= 5)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (dt4.Rows.Count > 0)
                        {
                            ...
                            if (dt6.Rows.Count < 1)
                            {
                                String SQL = "INSERT INTO ลูกผสม4 (ชื่อโค4,เลขโค4,ชื่อพ่อโค4,ชื่อแม่โค4,เลขพ่อโค4,เลขแม่โค4,ชื่อเจ้าของ,ชื่อฟาร์ม,สถานะ,day,รับ) VALUES('" + textBox1.Text + "' , '" + textBox2.Text + "' '" + textBox10.Text + "' '" + textBox11.Text + "' , '" + comboBox2.Text + "' , '" + comboBox4.Text + "' , '" + comboBox5.Text + "' , '" + comboBox3.Text + "' , '" + textBox7.Text + "' , '" + textBox8.Text + "' , 'ยังไม่ได้รับ' , '" + label14.Text + "' , '00/00/0000')";
