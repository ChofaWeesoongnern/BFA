...
namespace BFA
{
    public partial class Form39 : Form
    {
        ...
        private void showdata()
        {
            ...
            cmd.CommandText = "SELECT ชื่อโค100ตัวผู้,เลขโค100ตัวผู้,ชื่อเจ้าของ,ชื่อฟาร์ม,สถานะ,day,รับ FROM เลือดร้อยตัวผู้";
        ...
        private void Form39_Load(object sender, EventArgs e)
        {
            ...
            string sql = $"SELECT * FROM เลือดร้อยตัวผู้";
            ...
            string sql0 = $"SELECT * FROM เลือดร้อยตัวผู้ WHERE สถานะ = 'ได้รับแล้ว'";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            label4.Text = dataGridView1.Rows[e.RowIndex].Cells["ชื่อโค100ตัวผู้"].FormattedValue.ToString();
            label6.Text = dataGridView1.Rows[e.RowIndex].Cells["เลขโค100ตัวผู้"].FormattedValue.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MySqlConnection conn = new MySqlConnection("host=localhost;user=root;password=;database=สมาคมฟาร์มโค");
                    String sql = "UPDATE เลือดร้อยตัวผู้ SET สถานะ = '" + comboBox1.Text + "',รับ = '" + textBox1.Text + "' WHERE เลขโค100ตัวผู้ = '" + label6.Text + "'";
