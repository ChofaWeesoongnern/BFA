...
namespace BFA
{
    public partial class Form26 : Form
    {
        ...
        private void Form26_Shown(object sender, EventArgs e)
        {
            ...
            string sql2 = "SELECT * FROM เลือดร้อย";
        ...
        {
            MySqlConnection conn = new MySqlConnection("host=localhost;user=root;password=;database=สมาคมฟาร์มโค");
            string sql2 = "SELECT * FROM เลือดร้อย WHERE เลขโค100 like '" + comboBox2.Text + "' ";
            MySqlCommand cmd4 = new MySqlCommand(sql2, conn);
            conn.Open();
            DataTable dt4 = new DataTable();
            new MySqlDataAdapter(cmd4).Fill(dt4);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MySqlConnection conn = new MySqlConnection("host=localhost;user=root;password=;database=สมาคมฟาร์มโค");
                string sql6 = $"SELECT * FROM เลือดร้อย WHERE เลขโค100 = '{textBox2.Text}'";
                var cmd6 = new MySqlCommand(sql6, conn);
                DataTable dt6 = new DataTable();
                new MySqlDataAdapter(cmd6).Fill(dt6);
                if (dt6.Rows.Count < 2)
                {
                    string sql7 = $"SELECT * FROM เลือดร้อยตัวผู้ WHERE เลขโค100ตัวผู้ = '{textBox2.Text}'";
                    var cmd7 = new MySqlCommand(sql7, conn);
                    DataTable dt7 = new DataTable();
                    new MySqlDataAdapter(cmd7).Fill(dt7);
                    if (dt7.Rows.Count < 1)
                    {
                        String sql = "UPDATE เลือดร้อย SET ชื่อโค100 = '" + textBox1.Text + "',เลขโค100 = '" + textBox2.Text + "',ชื่อพ่อโค100 = '" + comboBox1.Text + "',ชื่อแม่โค100 = '" + comboBox4.Text + "',เลขพ่อโค100 = '" + comboBox5.Text + "',เลขแม่โค100 = '" + comboBox3.Text + "',ชื่อเจ้าของ = '" + comboBox6.Text + "',ชื่อฟาร์ม = '" + comboBox7.Text + "' WHERE เลขโค100 = '" + textBox2.Text + "'";
