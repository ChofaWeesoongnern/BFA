...
namespace BFA
{
    public partial class Form37 : Form
    {
        ...
        private void showdata()
        {
            ...
            cmd.CommandText = "SELECT ชื่อโค100,เลขโค100,ชื่อเจ้าของ,ชื่อฟาร์ม,สถานะ,day,รับ FROM เลือดร้อย";
        ...
        private void Form37_Load(object sender, EventArgs e)
        {
            ...
            string sql = $"SELECT * FROM เลือดร้อย";
            ...
            string sql0 = $"SELECT * FROM เลือดร้อย WHERE สถานะ = 'ได้รับแล้ว'";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            label4.Text = dataGridView1.Rows[e.RowIndex].Cells["ชื่อโค100"].FormattedValue.ToString();
            label6.Text = dataGridView1.Rows[e.RowIndex].Cells["เลขโค100"].FormattedValue.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MySqlConnection conn = new MySqlConnection("host=localhost;user=root;password=;database=สมาคมฟาร์มโค");
                    String sql = "UPDATE เลือดร้อย SET สถานะ = '" + comboBox1.Text + "',รับ = '" + textBox1.Text + "' WHERE เลขโค100 = '" + label6.Text + "'";
