...
namespace BFA
{
    public partial class Form40 : Form
    {
        ...
        private void showdata()
        {
            ...
            cmd.CommandText = "SELECT ชื่อโค,เลขโค,ชื่อเจ้าของ,ชื่อฟาร์ม,สถานะ,day,รับ FROM ลูกผสม";
        ...
        private void Form40_Load(object sender, EventArgs e)
        {
            ...
            string sql0 = $"SELECT * FROM ลูกผสม WHERE สถานะ = 'ได้รับแล้ว'";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            label4.Text = dataGridView1.Rows[e.RowIndex].Cells["ชื่อโค"].FormattedValue.ToString();
            label6.Text = dataGridView1.Rows[e.RowIndex].Cells["เลขโค"].FormattedValue.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MySqlConnection conn = new MySqlConnection("host=localhost;user=root;password=;database=สมาคมฟาร์มโค");
                    String sql = "UPDATE ลูกผสม SET สถานะ = '" + comboBox1.Text + "',รับ = '" + textBox1.Text + "' WHERE เลขโค = '" + label6.Text + "'";
