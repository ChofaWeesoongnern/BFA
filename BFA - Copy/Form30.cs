...
namespace BFA
{
    public partial class Form30 : Form
    {
        ...
        private void Form30_Shown(object sender, EventArgs e)
        {
            string sql2 = "SELECT * FROM ลูกผสม3";
            ...
            string sql4 = "SELECT * FROM ลูกผสม2";
        ...
        {
            string sql2 = "SELECT * FROM ลูกผสม3 WHERE เลขโค3 like '" + comboBox2.Text + "' ";
            MySqlConnection conn = new MySqlConnection("host=localhost;user=root;password=;database=สมาคมฟาร์มโค");
            MySqlCommand cmd4 = new MySqlCommand(sql2, conn);
            conn.Open();
            DataTable dt4 = new DataTable();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MySqlConnection conn = new MySqlConnection("host=localhost;user=root;password=;database=สมาคมฟาร์มโค");
                string sql6 = $"SELECT * FROM ลูกผสม3 WHERE เลขโค3 = '{textBox2.Text}'";
                var cmd6 = new MySqlCommand(sql6, conn);
                DataTable dt6 = new DataTable();
                new MySqlDataAdapter(cmd6).Fill(dt6);
                if (dt6.Rows.Count < 2)
                {
                    String sql = "UPDATE ลูกผสม3 SET ชื่อโค3 = '" + textBox1.Text + "',เลขโค3 = '" + textBox2.Text + "',ชื่อพ่อโค3 = '" + comboBox1.Text + "',ชื่อแม่โค3 = '" + comboBox4.Text + "',เลขพ่อโค3 = '" + comboBox5.Text + "',เลขแม่โค3 = '" + comboBox3.Text + "',ชื่อเจ้าของ = '" + comboBox6.Text + "',ชื่อฟาร์ม = '" + comboBox7.Text + "' WHERE เลขโค3 = '" + textBox2.Text + "'";
