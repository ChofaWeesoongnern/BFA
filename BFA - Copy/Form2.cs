                            ...
                            if (dt1.Rows.Count < 1)
                            {
                                ...
                                if (dt2.Rows.Count < 1)
                                {
                                    ...
                                    if (dt5.Rows.Count < 1)
                                    {
                                        ...
                                        {
                                            String sql = "INSERT INTO สมัครสมาชิกสมาคม (ชื่อ,ที่อยู่,เบอร์โทร,ชื่อฟาร์ม,username,password,ตัวย่อ,สถานะ,day,รับ) VALUES('" + textBox1.Text + "' , '" + textBox2.Text + "' , '" + textBox6.Text + "' , '" + textBox3.Text + "' , '" + textBox7.Text + "' , '" + textBox8.Text + "' , '" + textBox10.Text + "' , '" + label12.Text + "' , '" + label10.Text + "' , '" +label11.Text  + "')";
