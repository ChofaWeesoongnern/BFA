...
namespace BFA
{
    public partial class Form43 : Form
    {
        ...
        private void showdata()
        {
            ...
            cmd.CommandText = "SELECT ชื่อโค4,เลขโค4,ชื่อเจ้าของ,ชื่อฟาร์ม,สถานะ,day,รับ FROM ลูกผสม4";
        ...
        private void Form43_Load(object sender, EventArgs e)
        {
            ...
            string sql = $"SELECT * FROM ลูกผสม4";
            ...
            string sql0 = $"SELECT * FROM ลูกผสม4 WHERE สถานะ = 'ได้รับแล้ว'";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            label4.Text = dataGridView1.Rows[e.RowIndex].Cells["ชื่อโค4"].FormattedValue.ToString();
            label6.Text = dataGridView1.Rows[e.RowIndex].Cells["เลขโค4"].FormattedValue.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MySqlConnection conn = new MySqlConnection("host=localhost;user=root;password=;database=สมาคมฟาร์มโค");
                    String sql = "UPDATE ลูกผสม4 SET สถานะ = '" + comboBox1.Text + "',รับ = '" + textBox1.Text + "' WHERE เลขโค4 = '" + label6.Text + "'";
