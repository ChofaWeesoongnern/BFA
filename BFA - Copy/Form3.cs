...
namespace BFA
{
    public partial class Form3 : Form
    {
                ...
                if (textBox10.Text.Length <= 5)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (dt4.Rows.Count <= 0)
                        {
                            ...
                            if (dt5.Rows.Count > 0)
                            {
                                string sql6 = $"SELECT * FROM เลือดร้อย WHERE เลขโค100 = '{textBox2.Text+textBox10.Text}'";
                                var cmd6 = new MySqlCommand(sql6, conn);
                                DataTable dt6 = new DataTable();
                                new MySqlDataAdapter(cmd6).Fill(dt6);
                                if (dt6.Rows.Count < 1)
                                {
                                    string sql7 = $"SELECT * FROM เลือดร้อยตัวผู้ WHERE เลขโค100ตัวผู้ = '{textBox2.Text+textBox10.Text}'";
                                    var cmd7 = new MySqlCommand(sql7, conn);
                                    DataTable dt7 = new DataTable();
                                    new MySqlDataAdapter(cmd7).Fill(dt7);
                                    if (dt7.Rows.Count < 1)
                                    {
                                        String SQL = "INSERT INTO เลือดร้อย (ชื่อโค100,เลขโค100,ชื่อพ่อโค100,ชื่อแม่โค100,เลขพ่อโค100,เลขแม่โค100,ชื่อเจ้าของ,ชื่อฟาร์ม,สถานะ,day,รับ) VALUES('" + textBox1.Text + "' , '" + textBox2.Text + "' '" + textBox10.Text + "' , '" + comboBox2.Text + "' , '" + comboBox4.Text + "' , '" + comboBox1.Text + "' , '" + comboBox3.Text + "' , '" + textBox7.Text + "' , '" + textBox8.Text + "' , '" + label12.Text + "' , '" + label13.Text + "' , '" + label14.Text + "')";
        ...
        private void comboBox3_SelectedIndextChanged(object sender, EventArgs e)
        {
