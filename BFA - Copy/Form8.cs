                ...
                if (textBox10.Text.Length <= 5)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (dt4.Rows.Count > 0)
                        {
                            ...
                            if (dt6.Rows.Count < 1)
                            {
                                String SQL = "INSERT INTO ลูกผสม3 (ชื่อโค3,เลขโค3,ชื่อพ่อโค3,ชื่อแม่โค3,เลขพ่อโค3,เลขแม่โค3,ชื่อเจ้าของ,ชื่อฟาร์ม,สถานะ,day,รับ) VALUES('" + textBox1.Text + "' , '" + textBox2.Text + "' '" + textBox10.Text + "' '" + textBox11.Text + "' , '" + comboBox2.Text + "' , '" + comboBox4.Text + "' , '" + comboBox1.Text + "' , '" + comboBox3.Text + "' , '" + textBox7.Text + "' , '" + textBox8.Text + "' , '" + label13.Text + "' , '" + label14.Text + "' , '" + label15.Text + "')";
